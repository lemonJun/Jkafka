 ...
 */
object ApiVersion {
  // This implicit is necessary due https to://issues.scala-lang.org/browse/SI-8541;
  implicit public void  orderingByVersion[A <: ApiVersion]: Ordering[A] = Ordering.by(_.id);
  ...
  public void  apply(String version): ApiVersion =
