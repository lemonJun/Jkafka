...
object CommandLineUtils extends Logging {
   ...
   */
  public void  checkRequiredArgs(OptionParser parser, OptionSet options, OptionSpec required[_]*) {
    for (arg <- required) {
      if(!options.has(arg))
   ...
   */
  public void  checkInvalidArgs(OptionParser parser, OptionSet options, OptionSpec usedOption[_], Set invalidOptions<OptionSpec[_]>) {
   ...
   */
  public void  printUsageAndDie(OptionParser parser, String message): Nothing = {
   ...
   */
  public void  parseKeyValueArgs(Iterable args<String>, Boolean acceptMissingValue = true): Properties = {
