...
//
//object NotNothing {
//  private val NotNothing evidence<Any> = new Object with NotNothing<Any>;
//
//  implicit public void  notNothingEvidence[T](implicit T n =:= T): NotNothing[T] = evidence.asInstanceOf<NotNothing[T]>;
//}
