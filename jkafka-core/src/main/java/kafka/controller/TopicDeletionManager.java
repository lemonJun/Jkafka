 ...
 * @param controller
 */
class TopicDeletionManager(KafkaController controller, ControllerEventManager eventManager) extends Logging {
  ...
  public void  init(Set initialTopicsToBeDeleted<String>, Set initialTopicsIneligibleForDeletion<String>): Unit = {
  ...
  public void  tryTopicDeletion(): Unit = {
    if (isDeleteTopicEnabled) {
      resumeDeletions();
    }
  }
  ...
  private public void  isTopicIneligibleForDeletion(String topic): Boolean = {
    if(isDeleteTopicEnabled) {
  ...
  private public void  isTopicDeletionInProgress(String topic): Boolean = {
    if(isDeleteTopicEnabled) {
  ...
  public void  isTopicQueuedUpForDeletion(String topic): Boolean = {
    if(isDeleteTopicEnabled) {
   ...
   */
  public void  completeReplicaDeletion(Set replicas<PartitionAndReplica>) {
   ...
   */
  private public void  isTopicEligibleForDeletion(String topic): Boolean = {
   ...
   */
  private public void  markTopicForDeletionRetry(String topic) {
  ...
  private public void  completeDeleteTopic(String topic) {
   ...
   */
  private public void  onTopicDeletion(Set topics<String>) {
   ...
   */
  private public void  startReplicaDeletion(Set replicasForTopicsToBeDeleted<PartitionAndReplica>) {
   ...
   */
  private public void  onPartitionDeletion(Set partitionsToBeDeleted<TopicAndPartition>) {
    info(String.format("Partition deletion callback for %s",partitionsToBeDeleted.mkString(",")))
    val replicasPerPartition = controllerContext.replicasForPartition(partitionsToBeDeleted);
    startReplicaDeletion(replicasPerPartition);
  }

  private public void  resumeDeletions(): Unit = {
