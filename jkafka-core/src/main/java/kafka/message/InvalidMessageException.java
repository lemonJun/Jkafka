 ...
 */
class InvalidMessageException(String message, Throwable throwable) extends CorruptRecordException(message, throwable) {
  public void  this(String message) = this(null, null);
