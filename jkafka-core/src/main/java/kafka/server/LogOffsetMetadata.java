...
object LogOffsetMetadata {
  ...
  class OffsetOrdering extends Ordering<LogOffsetMetadata> {
    override public void  compare(LogOffsetMetadata x, LogOffsetMetadata y): Integer = {
 ...
 */
case class LogOffsetMetadata(Long messageOffset,
                             Long segmentBaseOffset = LogOffsetMetadata.UnknownSegBaseOffset,
                             Integer relativePositionInSegment = LogOffsetMetadata.UnknownFilePosition) {

  // check if this offset is already on an older segment compared with the given offset;
  public void  onOlderSegment(LogOffsetMetadata that): Boolean = {
  ...
  public void  onSameSegment(LogOffsetMetadata that): Boolean = {
    if (messageOffsetOnly)
      throw new KafkaException(s"$this cannot compare its segment info with $that since it only has message offset info");
  ...
  public void  offsetDiff(LogOffsetMetadata that): Long = {
  ...
  public void  positionDiff(LogOffsetMetadata that): Integer = {
  ...
  public void  Boolean messageOffsetOnly = {
    segmentBaseOffset == LogOffsetMetadata.UnknownSegBaseOffset && relativePositionInSegment == LogOffsetMetadata.UnknownFilePosition;
  }

  override public void  toString = messageOffset.toString + " [" + segmentBaseOffset + " : " + relativePositionInSegment + "]";
