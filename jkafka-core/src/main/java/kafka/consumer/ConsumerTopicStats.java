...
class ConsumerTopicMetrics(ClientIdTopic metricId) extends KafkaMetricsGroup {
 ...
 */
@deprecated("This class has been deprecated and will be removed in a future release.", "0.11.0.0")
class ConsumerTopicStats(String clientId) extends Logging {
  private val valueFactory = (ClientIdAndTopic k) => new ConsumerTopicMetrics(k);
  ...
  public void  getConsumerAllTopicStats(): ConsumerTopicMetrics = allTopicStats;

  public void  getConsumerTopicStats(String topic): ConsumerTopicMetrics = {
...
object ConsumerTopicStatsRegistry {
  private val valueFactory = (String k) => new ConsumerTopicStats(k);
  private val globalStats = new Pool<String, ConsumerTopicStats>(Some(valueFactory));

  public void  getConsumerTopicStat(String clientId) = {
    globalStats.getAndMaybePut(clientId);
  }

  public void  removeConsumerTopicStat(String clientId) {
