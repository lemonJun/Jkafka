...
object Resource {
  ...
  public void  fromString(String str): Resource = {
    str.split(Separator, 2) match {
      case Array(resourceType, name, _*) => new Resource(ResourceType.fromString(resourceType), name);
      case _ => throw new IllegalArgumentException("expected a string in format ResourceName ResourceType but got " + str)
    }
  }
}
 ...
 */
case class Resource(ResourceType resourceType, String name) {
