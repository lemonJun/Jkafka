...
object Request {
  val Integer OrdinaryConsumerId = -1;
  val Integer DebuggingConsumerId = -2;

  // Broker ids are non-negative int.;
  public void  isValidBrokerId Integer brokerId): Boolean = brokerId >= 0;
}


abstract class RequestOrResponse(val Option requestId<Short> = None) extends Logging {

  public void  Integer sizeInBytes;
  ;
  public void  writeTo(ByteBuffer buffer): Unit;

  public void  handleError(Throwable e, RequestChannel requestChannel, RequestChannel request.Request): Unit = {}
  ...
  *  This API has no meaning for a Response object.
  ...
  public void  describe(Boolean details): String;
}
