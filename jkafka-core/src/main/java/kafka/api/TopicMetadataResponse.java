...
object TopicMetadataResponse {
  ...
  public void  readFrom(ByteBuffer buffer): TopicMetadataResponse = {
...
case class TopicMetadataResponse(Seq brokers<BrokerEndPoint>,
                                 Seq topicsMetadata<TopicMetadata>,
                                 Integer correlationId);
    extends RequestOrResponse() {
  val Integer sizeInBytes = {
