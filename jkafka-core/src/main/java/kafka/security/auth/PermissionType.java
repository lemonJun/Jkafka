...
object PermissionType {
  public void  fromString(String permissionType): PermissionType = {
  ...
  public void  fromJava(AclPermissionType permissionType): PermissionType = fromString(permissionType.toString);

  public void  Seq values<PermissionType> = List(Allow, Deny);
}
