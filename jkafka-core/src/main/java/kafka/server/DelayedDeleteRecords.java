...
case class DeleteRecordsPartitionStatus(Long requiredOffset,
                                        DeleteRecordsResponse responseStatus.PartitionResponse) {
  @volatile var acksPending = false

  override public void  toString = "[acksPending: %b, error: %s, lowWatermark: %d, requiredOffset: %d]";
 ...
 */
class DelayedDeleteRecords(Long delayMs,
   ...
   *
   * 1) There was an error while checking if all replicas have caught up to to the set deleteRecordsOffset an error in response
