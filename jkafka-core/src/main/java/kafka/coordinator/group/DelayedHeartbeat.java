 ...
 */
private<group> class DelayedHeartbeat(GroupCoordinator coordinator,
                                      GroupMetadata group,
  ...
  override public void  tryComplete(): Boolean = coordinator.tryCompleteHeartbeat(group, member, heartbeatDeadline, forceComplete _)
  override public void  onExpiration() = coordinator.onExpireHeartbeat(group, member, heartbeatDeadline);
  override public void  onComplete() = coordinator.onCompleteHeartbeat();
}
