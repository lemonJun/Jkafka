...
class ZooKeeperMainWrapper(Array args<String>) extends ZooKeeperMain(args) {
  public void  runCmd(): Unit = {
    processCmd(this.cl);
    Exit.exit(0);
  }
}
...
object ZooKeeperMainWrapper {
  ...
  public void  main(Array args<String>): Unit = {
    val ZooKeeperMainWrapper main = new ZooKeeperMainWrapper(args);
    main.runCmd();
  }
}
