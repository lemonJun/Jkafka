...
sealed trait ResourceType extends BaseEnum {
  ...
  public void  JResourceType toJava;
}
...
object ResourceType {
  ...
  public void  fromString(String resourceType): ResourceType = {
  ...
  public void  Seq values<ResourceType> = List(Topic, Group, Cluster, TransactionalId);

  public void  fromJava(JResourceType operation): ResourceType = fromString(operation.toString.replaceAll("_", ""));
}
