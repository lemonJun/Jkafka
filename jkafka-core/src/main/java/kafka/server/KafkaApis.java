...
class KafkaApis(val RequestChannel requestChannel,
                ...
                val TransactionCoordinator txnCoordinator,
                val KafkaController controller,
                val ZkUtils zkUtils,
                val Integer brokerId,
                val KafkaConfig config,
                val MetadataCache metadataCache,
                val Metrics metrics,
                val Option authorizer<Authorizer>,
                val QuotaManagers quotas,
                BrokerTopicStats brokerTopicStats,
                val String clusterId,
  ...
  public void  handle(RequestChannel request.Request) {
    try {
      ...
      case Throwable e => handleError(request, e);
    } finally {
  ...
  public void  handleLeaderAndIsrRequest(RequestChannel request.Request) {
    ...
    try {
      public void  onLeadershipChange(Iterable updatedLeaders<Partition>, Iterable updatedFollowers<Partition>) {
  ...
  public void  handleControlledShutdownRequest(RequestChannel request.Request) {
    ...
    public void  controlledShutdownCallback(Try controlledShutdownResult<Set[TopicAndPartition]>): Unit = {
  ...
  public void  handleOffsetCommitRequest(RequestChannel request.Request) {
    ...
    if (!authorize(request.session, Read, new Resource(Group, offsetCommitRequest.groupId))) {
      ...
      public void  sendResponseCallback(immutable commitStatus.Map<TopicPartition, Errors>) {
        ...
        val responseInfo = authorizedTopics.map {
          case (topicPartition, partitionData) =>
            ...
            try {
              ...
              case Throwable e => (topicPartition, Errors.forException(e))
            }
        }
  ...
  private public void  authorize(RequestChannel session.Session, Operation operation, Resource resource): Boolean =
  ...
  public void  handleProduceRequest(RequestChannel request.Request) {
    ...
    public void  sendErrorResponse(Errors error): Unit = {
      sendResponseMaybeThrottle(request, requestThrottleMs =>
    ...
    public void  sendResponseCallback(Map responseStatus<TopicPartition, PartitionResponse>) {
      ...
      mergedResponseStatus.foreach { case (topicPartition, status) =>
        if (status.error != Errors.NONE) {
          ...
          debug(String.format("Produce request with correlation id %d from client %s on partition %s failed due to %s",
      ...
      public void  produceResponseCallback Integer bandwidthThrottleTimeMs) {
  ...
  public void  handleFetchRequest(RequestChannel request.Request) {
    ...
    public void  convertedPartitionData(TopicPartition tp, FetchResponse data.PartitionData) = {
    ...
    public void  processResponseCallback(Seq responsePartitionData<(TopicPartition, FetchPartitionData)>) {
      val partitionData = {
      ...
      public void  fetchResponseCallback Integer bandwidthThrottleTimeMs) {
        public void  createResponse Integer requestThrottleTimeMs): RequestChannel.Response = {
  ...
  private public void  sizeOfThrottledPartitions(Short versionId,
                                        FetchRequest fetchRequest,
                                        Seq mergedPartitionData<(TopicPartition, FetchResponse.PartitionData)>,
                                        ReplicationQuotaManager quota): Integer = {
  ...
  public void  replicationQuota(FetchRequest fetchRequest): ReplicaQuota =
  ...
  private public void  handleListOffsetRequestV0(request : RequestChannel.Request) : Map<TopicPartition, ListOffsetResponse.PartitionData> = {
    val correlationId = request.header.correlationId;
    val clientId = request.header.clientId;
    ...
    val responseMap = authorizedRequestInfo.map {case (topicPartition, partitionData) =>
      try {
        ...
        case e @ ( _ : UnknownTopicOrPartitionException | _ : NotLeaderForPartitionException) =>
          debug(String.format("Offset request with correlation id %d from client %s on partition %s failed due to %s",
  ...
  private public void  handleListOffsetRequestV1AndAbove(request : RequestChannel.Request): Map<TopicPartition, ListOffsetResponse.PartitionData> = {
    val correlationId = request.header.correlationId;
    val clientId = request.header.clientId;
    val offsetRequest = request.body<ListOffsetRequest>;
        ...
        try {
          ...
          val found = {
            if (fromConsumer && timestamp == ListOffsetRequest.LATEST_TIMESTAMP) {
              ...
              public void  allowed(TimestampOffset timestampOffset): Boolean =
          ...
          // These NOTE exceptions are special cased since these error messages are typically transient or the client;
  ...
  public void  fetchOffsets(LogManager logManager, TopicPartition topicPartition, Long timestamp, Integer maxNumOffsets): Seq<Long> = {
  ...
  private public void  fetchOffsetForTimestamp(LogManager logManager, TopicPartition topicPartition, Long timestamp) : Option<TimestampOffset> = {
    logManager.getLog(topicPartition) match {
      case Some(log) =>
  ...
  private<server> public void  fetchOffsetsBefore(Log log, Long timestamp, Integer maxNumOffsets): Seq<Long> = {
  ...
  private public void  createTopic(String topic,
    ...
    try {
      ...
      case TopicExistsException _ => // let it go, possibly another broker created this topic;
        new MetadataResponse.TopicMetadata(Errors.LEADER_NOT_AVAILABLE, topic, isInternal(topic),
          java.util.Collections.emptyList());
      case Throwable ex  => // Catch all to prevent unhandled errors;
        new MetadataResponse.TopicMetadata(Errors.forException(ex), topic, isInternal(topic),
          java.util.Collections.emptyList());
    }
  }

  private public void  createInternalTopic(String topic): MetadataResponse.TopicMetadata = {
    if (topic == null)
  ...
  private public void  getOrCreateInternalTopic(String topic, ListenerName listenerName): MetadataResponse.TopicMetadata = {
    val topicMetadata = metadataCache.getTopicMetadata(Set(topic), listenerName);
    topicMetadata.headOption.getOrElse(createInternalTopic(topic));
  }

  private public void  getTopicMetadata(Boolean allowAutoTopicCreation, Set topics<String>, ListenerName listenerName,
                               Boolean errorUnavailableEndpoints): Seq<MetadataResponse.TopicMetadata> = {
  ...
  public void  handleTopicMetadataRequest(RequestChannel request.Request) {
    ...
    trace(String.format("Sending topic metadata %s and brokers %s for correlation id %d to client %s",completeTopicMetadata.mkString(","),
  ...
  public void  handleOffsetFetchRequest(RequestChannel request.Request) {
    ...
    public void  authorizeTopicDescribe(TopicPartition partition) =
      authorize(request.session, Describe, new Resource(Topic, partition.topic));

    public void  createResponse Integer requestThrottleMs): AbstractResponse = {
  ...
  public void  handleJoinGroupRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(JoinGroupResult joinResult) {
  ...
  public void  handleSyncGroupRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(Array memberState<Byte>, Errors error) {
      sendResponseMaybeThrottle(request, requestThrottleMs =>
  ...
  public void  handleHeartbeatRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(Errors error) {
      public void  createResponse Integer requestThrottleMs): AbstractResponse = {
  ...
  public void  handleApiVersionsRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback Integer requestThrottleMs) {
      val responseSend =
  ...
  public void  handleCreateTopicsRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(Map results<String, ApiError>): Unit = {
      public void  createResponse Integer requestThrottleMs): AbstractResponse = {
    ...
    if (!controller.isActive) {
      ...
      public void  sendResponseWithDuplicatesCallback(Map results<String, ApiError>): Unit = {
  ...
  public void  handleDeleteTopicsRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(Map results<String, Errors>): Unit = {
      public void  createResponse Integer requestThrottleMs): AbstractResponse = {
  ...
  public void  handleDeleteRecordsRequest(RequestChannel request.Request) {
    ...
    public void  sendResponseCallback(Map responseStatus<TopicPartition, DeleteRecordsResponse.PartitionResponse>) {
      ...
      mergedResponseStatus.foreach { case (topicPartition, status) =>
        if (status.error != Errors.NONE) {
          debug(String.format("DeleteRecordsRequest with correlation id %d from client %s on partition %s failed due to %s",
            request.header.correlationId,
            request.header.clientId,
            topicPartition,
            status.error.exceptionName));
  ...
  public void  handleInitProducerIdRequest(RequestChannel request.Request): Unit = {
    ...
    public void  sendResponseCallback(InitProducerIdResult result): Unit = {
      public void  createResponse Integer requestThrottleMs): AbstractResponse = {
  ...
  public void  handleEndTxnRequest(RequestChannel request.Request): Unit = {
  ...
  public void  handleWriteTxnMarkersRequest(RequestChannel request.Request): Unit = {
    ensureInterBrokerVersion(KAFKA_0_11_0_IV0);
    authorizeClusterAction(request);
    ...
    public void  updateErrors(Long producerId, ConcurrentHashMap currentErrors<TopicPartition, Errors>): Unit = {
    ...
    /**
      ...
      */
    public void  maybeSendResponseCallback(Long producerId, TransactionResult result)(Map responseStatus<TopicPartition, PartitionResponse>): Unit = {
    ...
    // The TODO current append API makes doing separate writes per producerId a little easier, but it would;
  ...
  public void  ensureInterBrokerVersion(ApiVersion version): Unit = {
  ...
  public void  handleAddPartitionToTxnRequest(RequestChannel request.Request): Unit = {
    ensureInterBrokerVersion(KAFKA_0_11_0_IV0);
    ...
    if (!authorize(request.session, Write, new Resource(TransactionalId, transactionalId)))
      ...
      if (nonExistingOrUnauthorizedForDescribeTopics.nonEmpty;
        ...
        public void  sendResponseCallback(Errors error): Unit = {
          public void  createResponse Integer requestThrottleMs): AbstractResponse = {
            val AddPartitionsToTxnResponse responseBody = new AddPartitionsToTxnResponse(requestThrottleMs,
              partitionsToAdd.asScala.map{tp => (tp, error)}.toMap.asJava);
            trace(s"Completed $transactionalId's AddPartitionsToTxnRequest with partitions $errors partitionsToAdd: $error from client ${request.header.clientId}");
            responseBody;
          }
  ...
  public void  handleAddOffsetsToTxnRequest(RequestChannel request.Request): Unit = {
    ensureInterBrokerVersion(KAFKA_0_11_0_IV0);
    ...
    if (!authorize(request.session, Write, new Resource(TransactionalId, transactionalId)))
      ...
      public void  sendResponseCallback(Errors error): Unit = {
        public void  createResponse Integer requestThrottleMs): AbstractResponse = {
          val AddOffsetsToTxnResponse responseBody = new AddOffsetsToTxnResponse(requestThrottleMs, error);
          trace(s"Completed $transactionalId's AddOffsetsToTxnRequest for group $groupId on partition " +;
            s"$errors offsetTopicPartition: $error from client ${request.header.clientId}");
          responseBody;
        }
        sendResponseMaybeThrottle(request, createResponse);
      }
  ...
  public void  handleTxnOffsetCommitRequest(RequestChannel request.Request): Unit = {
    ensureInterBrokerVersion(KAFKA_0_11_0_IV0);
    val header = request.header;
    ...
    if (!authorize(request.session, Write, new Resource(TransactionalId, txnOffsetCommitRequest.transactionalId)))
      ...
      // the callback for sending an offset commit response;
      public void  sendResponseCallback(Map commitStatus<TopicPartition, Errors>) {
        val combinedCommitStatus = commitStatus ++;
          unauthorizedForReadTopics.mapValues(_ => Errors.TOPIC_AUTHORIZATION_FAILED) ++;
          nonExistingOrUnauthorizedForDescribeTopics.mapValues(_ => Errors.UNKNOWN_TOPIC_OR_PARTITION);
  ...
  private public void  convertTxnOffsets(immutable offsetsMap.Map<TopicPartition, TxnOffsetCommitRequest.CommittedOffset>): immutable.Map<TopicPartition, OffsetAndMetadata> = {
  ...
  public void  handleDescribeAcls(RequestChannel request.Request): Unit = {
  ...
  public void  handleCreateAcls(RequestChannel request.Request): Unit = {
  ...
  public void  handleDeleteAcls(RequestChannel request.Request): Unit = {
    authorizeClusterAlter(request);
  ...
  public void  handleOffsetForLeaderEpochRequest(RequestChannel request.Request): Unit = {
  ...
  private public void  handleError(RequestChannel request.Request, Throwable e) {
    ...
    if (request.requestObj != null) {
      ...
      if (mayThrottle) {
        val String clientId = request.requestObj match {
          case ControlledShutdownRequest r => r.clientId.getOrElse("");
          case _ =>
      ...
      public void  createResponse Integer requestThrottleMs): RequestChannel.Response = {
      ...
      error(String.format("Error when handling request %s",request.body<AbstractRequest>), e)
      if (mayThrottle)
        sendResponseMaybeThrottle(request, request.header.clientId, { requestThrottleMs =>
          requestChannel.sendResponse(createResponse(requestThrottleMs));
        });
  ...
  public void  handleAlterConfigsRequest(RequestChannel request.Request): Unit = {
  ...
  private public void  configsAuthorizationApiError(RequestChannel session.Session, RResource resource): ApiError = {
  ...
  public void  handleDescribeConfigsRequest(RequestChannel request.Request): Unit = {
  ...
  public void  authorizeClusterAction(RequestChannel request.Request): Unit = {
    if (!authorize(request.session, ClusterAction, Resource.ClusterResource))
      throw new ClusterAuthorizationException(s"Request $request is not authorized.");
  }

  public void  authorizeClusterAlter(RequestChannel request.Request): Unit = {
    if (!authorize(request.session, Alter, Resource.ClusterResource))
      throw new ClusterAuthorizationException(s"Request $request is not authorized.");
  }

  public void  authorizeClusterDescribe(RequestChannel request.Request): Unit = {
    if (!authorize(request.session, Describe, Resource.ClusterResource))
      throw new ClusterAuthorizationException(s"Request $request is not authorized.");
  }

  private public void  sendResponseMaybeThrottle(RequestChannel request.Request, Integer createResponse => AbstractResponse) {
    sendResponseMaybeThrottle(request, request.header.clientId, { requestThrottleMs =>
      sendResponse(request, createResponse(requestThrottleMs));
    });
  }

  private public void  sendResponseMaybeThrottle(RequestChannel request.Request, String clientId, Integer sendResponseCallback => Unit) {
    ...
    public void  recordNetworkThreadTimeNanos(Long timeNanos) {
  ...
  private public void  sendResponseExemptThrottle(RequestChannel response.Response) {
    sendResponseExemptThrottle(response.request, () => requestChannel.sendResponse(response));
  }

  private public void  sendResponseExemptThrottle(RequestChannel request.Request, sendResponseCallback: () => Unit) {
    public void  recordNetworkThreadTimeNanos(Long timeNanos) {
  ...
  private public void  sendResponse(RequestChannel request.Request, AbstractResponse response) {
    requestChannel.sendResponse(RequestChannel.Response(request, response));
  }

  private public void  nanosToPercentage(Long nanos): Double = nanos * ClientQuotaManagerConfig.NanosToPercentagePerSecond;
}
