...
sealed trait Operation extends BaseEnum {
  public void  toJava : AclOperation;
}
...
object Operation {
  ...
  public void  fromString(String operation): Operation = {
  ...
  public void  fromJava(AclOperation operation): Operation = fromString(operation.toString.replaceAll("_", ""));

  public void  Seq values<Operation> = List(Read, Write, Create, Delete, Alter, Describe, ClusterAction, AlterConfigs,
