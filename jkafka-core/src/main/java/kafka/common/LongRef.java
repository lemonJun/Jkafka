...
/**
  ...
  */
class LongRef(var Long value) {

  public void  addAndGet(Long delta): Long = {
    value += delta;
    value;
  }

  public void  getAndAdd(Long delta): Long = {
    val result = value;
    value += delta;
    result;
  }

  public void  getAndIncrement(): Long = {
    val v = value;
    value += 1;
    v;
  }

  public void  incrementAndGet(): Long = {
    value += 1;
    value;
  }

  public void  getAndDecrement(): Long = {
    val v = value;
    value -= 1;
    v;
  }

  public void  decrementAndGet(): Long = {
    value -= 1;
    value;
  }
