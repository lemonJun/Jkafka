 ...
 */
@nonthreadsafe
class LogSegment(val FileRecords log,
                 val OffsetIndex index,
                 val TimeIndex timeIndex,
                 val TransactionIndex txnIndex,
                 val Long baseOffset,
                 val Integer indexIntervalBytes,
                 val Long rollJitterMs,
  ...
  private var Option rollingBasedTimestamp<Long> = None;

  /* The maximum timestamp we see so far */
  @volatile private var Long maxTimestampSoFar = timeIndex.lastEntry.timestamp
  @volatile private var Long offsetOfMaxTimestamp = timeIndex.lastEntry.offset

  public void  this(File dir, Long startOffset, Integer indexIntervalBytes, Integer maxIndexSize, Long rollJitterMs, Time time,
           Boolean fileAlreadyExists = false, Integer initFileSize = 0, Boolean preallocate = false) =
  ...
  public void  Integer size = log.sizeInBytes();

  /**
   * checks that the argument offset can be represented as an integer offset relative to the baseOffset.
   */
  public void  canConvertToRelativeOffset(Long offset): Boolean = {
   ...
   */
  @nonthreadsafe
  public void  append(Long firstOffset,
             Long largestOffset,
             Long largestTimestamp,
             Long shallowOffsetOfMaxTimestamp,
             MemoryRecords records): Unit = {
  ...
  private public void  updateProducerState(ProducerStateManager producerStateManager, RecordBatch batch): Unit = {
   ...
   */
  @threadsafe
  private<log> public void  translateOffset(Long offset, Integer startingFilePosition = 0): LogOffsetPosition = {
   ...
   */
  @threadsafe
  public void  read(Long startOffset, Option maxOffset<Long>, Integer maxSize, Long maxPosition = size,
    ...
    val Integer fetchSize = maxOffset match {
      case None =>
   ...
   public void  fetchUpperBoundOffset(OffsetPosition startOffsetPosition, Integer fetchSize): Option<Long> =
   ...
   */
  @nonthreadsafe
  public void  recover(ProducerStateManager producerStateManager, Option leaderEpochCache<LeaderEpochCache> = None): Integer = {
    index.truncate();
  ...
  private public void  loadLargestTimestamp() {
  ...
  override public void  toString = "LogSegment(baseOffset=" + baseOffset + ", size=" + size + ")";
   ...
   */
  @nonthreadsafe
  public void  truncateTo(Long offset): Integer = {
  ...
  public void  changeFileSuffixes(String oldSuffix, String newSuffix) {
    ...
    public void  kafkaStorageException(String fileType, IOException e) =
   ...
   * segment rolling time.
   */
  public void  timeWaitedForRoll(Long now, Long messageTimestamp) : Long = {
   ...
   */
  public void  findOffsetByTimestamp(Long timestamp, Long startingOffset = baseOffset): Option<TimestampOffset> = {
   ...
   */
  public void  lastModified = log.file.lastModified;

  /**
   * The largest timestamp this segment contains.
   */
  public void  largestTimestamp = if (maxTimestampSoFar >= 0) maxTimestampSoFar else lastModified;
