...
trait PartitionLeaderSelector {
   ...
   */
  public void  selectLeader(TopicAndPartition topicAndPartition, LeaderAndIsr currentLeaderAndIsr): (LeaderAndIsr, Seq<Int>);
 ...
 */
class OfflinePartitionLeaderSelector(ControllerContext controllerContext, KafkaConfig config);
...
class ReassignedPartitionLeaderSelector(ControllerContext controllerContext) extends PartitionLeaderSelector with Logging {
   ...
   */
  public void  selectLeader(TopicAndPartition topicAndPartition,
                   LeaderAndIsr currentLeaderAndIsr): (LeaderAndIsr, Seq<Int>) = {
