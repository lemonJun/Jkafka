...
/**
  ...
  */
case class DeleteTopicMetadata(String topic, Errors error);

/**
  * A delayed delete topics operation that can be created by the admin manager and watched
  * in the topic purgatory
  */
class DelayedDeleteTopics(Long delayMs,
                          Seq deleteMetadata<DeleteTopicMetadata>,
  ...
  private public void  topicExists(String topic): Boolean = {
