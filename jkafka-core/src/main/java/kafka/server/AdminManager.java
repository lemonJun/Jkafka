...
class AdminManager(val KafkaConfig config,
                   val Metrics metrics,
  ...
  public void  hasDelayedTopicOperations = topicPurgatory.delayed != 0;
  ...
  /**
    ...
    */
  public void  createTopics Integer timeout,
                   Boolean validateOnly,
                   Map createInfo<String, TopicDetails>,
                   Map responseCallback<String, ApiError> => Unit) {
      ...
      try {
        ...
        val assignments = {
          if ((arguments.numPartitions != NO_NUM_PARTITIONS || arguments.replicationFactor != NO_REPLICATION_FACTOR)
            ...
            // we Note don't check that replicaAssignment contains unknown brokers - unlike in add-partitions case,
        ...
        case e@ (PolicyViolationException _ | ApiException _) =>
  ...
  /**
    ...
    */
  public void  deleteTopics Integer timeout,
                   Set topics<String>,
                   Map responseCallback<String, Errors> => Unit) {
    ...
    val metadata = topics.map { topic =>
        try {
          ...
          case TopicAlreadyMarkedForDeletionException _ =>
  ...
  public void  describeConfigs(Map resourceToConfigNames<Resource, Option[Set[String]]>): Map<Resource, DescribeConfigsResponse.Config> = {
    resourceToConfigNames.map { case (resource, configNames) =>

      public void  createResponseConfig(AbstractConfig config, Boolean isReadOnly, String isDefault => Boolean): DescribeConfigsResponse.Config = {
  ...
  public void  alterConfigs(Map configs<Resource, AlterConfigsRequest.Config>, Boolean validateOnly): Map<Resource, ApiError> = {
