...
trait OffsetMap {
  public void  Integer slots;
  public void  put(ByteBuffer key, Long offset);
  public void  get(ByteBuffer key): Long;
  public void  updateLatestOffset(Long offset);
  public void  clear();
  public void  Integer size;
  public void  Double utilization = size.toDouble / slots;
  public void  Long latestOffset;
}
 ...
 */
@nonthreadsafe
class SkimpyOffsetMap(val Integer memory, val String hashAlgorithm = "MD5") extends OffsetMap {
   ...
   */
  val Integer slots = memory / bytesPerEntry;
  ;
  /**
   ...
   */
  override public void  put(ByteBuffer key, Long offset) {
   ...
   */
  private public void  isEmpty Integer position): Boolean = ;
   ...
   */
  override public void  get(ByteBuffer key): Long = {
    lookups += 1;
    hashInto(key, hash1);
   ...
   */
  override public void  Integer size = entries;
  ;
  /**
   * The rate of collisions in the lookups
   */
  public void  Double collisionRate = ;
    (this.probes - this.lookups) / this.lookups.toDouble;

  /**
   * The latest offset put into the map
   */
  override public void  Long latestOffset = lastOffset;

  override public void  updateLatestOffset(Long offset): Unit = {
    lastOffset = offset;
  }
   ...
   */
  private public void  positionOf(Array hash<Byte>, Integer attempt): Integer = {
   ...
   */
  private public void  hashInto(ByteBuffer key, Array buffer<Byte>) {
    key.mark();
    digest.update(key);
    key.reset();
