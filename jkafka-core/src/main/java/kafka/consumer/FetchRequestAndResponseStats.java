...
class FetchRequestAndResponseMetrics(ClientIdBroker metricId) extends KafkaMetricsGroup {
 ...
 */
@deprecated("This class has been deprecated and will be removed in a future release.", "0.11.0.0")
class FetchRequestAndResponseStats(String clientId) {
  private val valueFactory = (ClientIdBroker k) => new FetchRequestAndResponseMetrics(k);
  ...
  public void  getFetchRequestAndResponseAllBrokersStats(): FetchRequestAndResponseMetrics = allBrokersStats;

  public void  getFetchRequestAndResponseStats(String brokerHost, Integer brokerPort): FetchRequestAndResponseMetrics = {
...
object FetchRequestAndResponseStatsRegistry {
  private val valueFactory = (String k) => new FetchRequestAndResponseStats(k);
  private val globalStats = new Pool<String, FetchRequestAndResponseStats>(Some(valueFactory));

  public void  getFetchRequestAndResponseStats(String clientId) = {
