...
trait AsyncProducerConfig {
  val VerifiableProperties props;
   ...
   * events 0 will be enqueued immediately or dropped if the queue is full
   * -enqueue ve will block indefinitely if the queue is full
   * +enqueue ve will block up to this many milliseconds if the queue is full
   */
