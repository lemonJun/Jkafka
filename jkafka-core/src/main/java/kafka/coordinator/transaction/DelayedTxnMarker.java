...
/**
  ...
  */
private<transaction> class DelayedTxnMarker(TransactionMetadata txnMetadata,
                                           Errors completionCallback => Unit);
  ...
  // if TODO we will always return NONE upon completion, we can remove the error code in the param;
  override public void  onComplete(): Unit = completionCallback(Errors.NONE);
