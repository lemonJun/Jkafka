...
@threadsafe
class ProducerTopicMetrics(ClientIdTopic metricId) extends KafkaMetricsGroup {
 ...
 */
@deprecated("This class has been deprecated and will be removed in a future release.", "0.10.0.0")
class ProducerTopicStats(String clientId) {
  private val valueFactory = (ClientIdTopic k) => new ProducerTopicMetrics(k);
  ...
  public void  getProducerAllTopicsStats(): ProducerTopicMetrics = allTopicsStats;

  public void  getProducerTopicStats(String topic): ProducerTopicMetrics = {
...
object ProducerTopicStatsRegistry {
  private val valueFactory = (String k) => new ProducerTopicStats(k);
  private val globalStats = new Pool<String, ProducerTopicStats>(Some(valueFactory));

  public void  getProducerTopicStats(String clientId) = {
    globalStats.getAndMaybePut(clientId);
  }

  public void  removeProducerTopicStats(String clientId) {
