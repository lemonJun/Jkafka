 ...
 */
case class CleanerConfig Integer numThreads = 1,
                         Long dedupeBufferSize = 4*1024*1024L,
                         Double dedupeBufferLoadFactor = 0.9d,
                         Integer ioBufferSize = 1024*1024,
                         Integer maxMessageSize = 32*1024*1024,
                         Double maxIoBytesPerSecond = Double.MaxValue,
                         Long backOffMs = 15 * 1000,
                         Boolean enableCleaner = true,
