 ...
 */
case class ClientSensors(QuotaEntity quotaEntity, Sensor quotaSensor, Sensor throttleTimeSensor);
 ...
 *
 */
case class ClientQuotaManagerConfig(Long quotaBytesPerSecondDefault =
                                        ClientQuotaManagerConfig.QuotaBytesPerSecondDefault,
                                    Integer numQuotaSamples =
                                        ClientQuotaManagerConfig.DefaultNumQuotaSamples,
                                    Integer quotaWindowSizeSeconds =
...
object QuotaId {
   ...
   */
  public void  sanitize(String user): String = {
   ...
   */
  public void  desanitize(String sanitizedUser): String = {
    URLDecoder.decode(sanitizedUser, StandardCharsets.UTF_8.name);
  }
}

case class QuotaId(Option sanitizedUser<String>, Option clientId<String>);

case class QuotaEntity(QuotaId quotaId, String sanitizedUser, String clientId, Quota quota);
 ...
 */
class ClientQuotaManager(private val ClientQuotaManagerConfig config,
  ...
  class ThrottledRequestReaper(DelayQueue delayQueue<ThrottledResponse>) extends ShutdownableThread(
    String.format("ThrottledRequestReaper-%s",quotaType), false) {

    override public void  doWork(): Unit = {
      val ThrottledResponse response = delayQueue.poll(1, TimeUnit.SECONDS);
      if (response != null) {
   ...
   *         Zero otherwise
   */
  public void  recordAndMaybeThrottle(String sanitizedUser, String clientId, Double value, Integer callback => Unit): Integer = {
  ...
  public void  recordAndThrottleOnQuotaViolation(ClientSensors clientSensors, Double value, Integer callback => Unit): Integer = {
    ...
    try {
      ...
      case QuotaViolationException _ =>
        // Compute the delay;
        ...
        logger.debug(String.format("Quota violated for sensor (%s). Delay time: (%d)",clientSensors.quotaSensor.name(), throttleTimeMs))
    }
    throttleTimeMs;
  }
   ...
   *
   */
  private public void  quotaEntity(String sanitizedUser, String clientId) : QuotaEntity = {
  ...
  private public void  quotaEntityWithMultipleQuotaLevels(String sanitizedUser, String clientId) : QuotaEntity = {
   ...
   */
  public void  quota(String user, String clientId) = {
   ...
   */
  protected public void  throttleTime(KafkaMetric clientMetric, MetricConfig config): Long = {
    val Rate rateMetric = measurableAsRate(clientMetric.metricName(), clientMetric.measurable());
  ...
  private public void  measurableAsRate(MetricName name, Measurable measurable): Rate = {
    measurable match {
      case Rate r => r;
   ...
   */
  public void  getOrCreateQuotaSensors(String sanitizedUser, String clientId): ClientSensors = {
  ...
  private public void  MeasurableStat measurableStat = new Rate();

  private public void  getThrottleTimeSensorName(QuotaId quotaId): String = quotaType + "ThrottleTime-" + quotaId.sanitizedUser.getOrElse("") + ':' + quotaId.clientId.getOrElse("");

  private public void  getQuotaSensorName(QuotaId quotaId): String = quotaType + "-" + quotaId.sanitizedUser.getOrElse("") + ':' + quotaId.clientId.getOrElse("");

  protected public void  getQuotaMetricConfig(Quota quota): MetricConfig = {
    new MetricConfig();
  ...
  protected public void  createSensor(String sensorName, MetricName metricName): Sensor = {
    sensorAccessor.getOrCreate(
        sensorName,
        ClientQuotaManagerConfig.InactiveSensorExpirationTimeSeconds,
        lock, metrics,
   ...
   */
  public void  updateQuota(Option sanitizedUser<String>, Option clientId<String>, Option quota<Quota>) {
    /*
  ...
  protected public void  clientRateMetricName(String sanitizedUser, String clientId): MetricName = {
  ...
  private public void  throttleMetricName(QuotaEntity quotaEntity): MetricName = {
