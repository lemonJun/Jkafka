...
object DynamicConfig {
  ...
  object Broker {
    ...
    public void  names = brokerConfigDef.names;

    public void  validate(Properties props) = DynamicConfig.validate(brokerConfigDef, props);
  }
  ...
  object Client {
    ...
    public void  names = clientConfigs.names;

    public void  validate(Properties props) = DynamicConfig.validate(clientConfigs, props);
  }
  ...
  object User {
    ...
    public void  names = userConfigs.names;

    public void  validate(Properties props) = DynamicConfig.validate(userConfigs, props);
  }

  private public void  validate(ConfigDef configDef, Properties props) = {
    //Validate Names;
