...
class SensorAccess {
  ...
  public void  getOrCreate(String sensorName, Long expirationTime, ReentrantReadWriteLock lock, Metrics metrics, metricName: () => MetricName, config: () => MetricConfig, measure: () => MeasurableStat): Sensor = {
