...
class ProducerStats(String clientId) extends KafkaMetricsGroup {
  val Map tags<String, String> = Map("clientId" -> clientId);
...
object ProducerStatsRegistry {
  private val valueFactory = (String k) => new ProducerStats(k);
  private val statsRegistry = new Pool<String, ProducerStats>(Some(valueFactory));

  public void  getProducerStats(String clientId) = {
    statsRegistry.getAndMaybePut(clientId);
  }

  public void  removeProducerStats(String clientId) {
