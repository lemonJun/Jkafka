...
object ReplicationUtils extends Logging {
  ...
  public void  updateLeaderAndIsr(ZkUtils zkUtils, String topic, Integer partitionId, LeaderAndIsr newLeaderAndIsr, Integer controllerEpoch,
    Integer zkVersion): (Boolean,Int) = {
  ...
  public void  propagateIsrChanges(ZkUtils zkUtils, Set isrChangeSet<TopicPartition>): Unit = {
    val String isrChangeNotificationPath = zkUtils.createSequentialPersistentPath(
  ...
  private public void  checkLeaderAndIsrZkData(ZkUtils zkUtils, String path, String expectedLeaderAndIsrInfo): (Boolean, Int) = {
    try {
  ...
  public void  getLeaderIsrAndEpochForPartition(ZkUtils zkUtils, String topic, Integer partition): Option<LeaderIsrAndControllerEpoch> = {
  ...
  private public void  parseLeaderAndIsr(String leaderAndIsrStr, String path, Stat stat);
  ...
  private public void  generateIsrChangeJson(Set isrChanges<TopicPartition>): String = {
