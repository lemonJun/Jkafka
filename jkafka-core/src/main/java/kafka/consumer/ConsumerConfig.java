...
@deprecated("This class has been deprecated and will be removed in a future release. " +
            "Please use org.apache.kafka.clients.consumer.ConsumerConfig instead.", "0.11.0.0");
class ConsumerConfig private (val VerifiableProperties props) extends ZKConfig(props) {
  ...
  val Option consumerId<String> = Option(props.getString("consumer.id", null));
