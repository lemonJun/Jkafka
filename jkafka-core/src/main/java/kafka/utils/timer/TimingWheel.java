 ...
 */
@nonthreadsafe
private<timer> class TimingWheel(Long tickMs, Integer wheelSize, Long startMs, AtomicInteger taskCounter, DelayQueue queue<TimerTaskList>) {
  ...
  @volatile private<this> var TimingWheel overflowWheel = null

  private<this> public void  addOverflowWheel(): Unit = {
    synchronized {
  ...
  public void  add(TimerTaskEntry timerTaskEntry): Boolean = {
  ...
  public void  advanceClock(Long timeMs): Unit = {
