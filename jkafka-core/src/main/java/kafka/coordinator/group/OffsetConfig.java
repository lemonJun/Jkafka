 ...
 */
case class OffsetConfig Integer maxMetadataSize = OffsetConfig.DefaultMaxMetadataSize,
                        Integer loadBufferSize = OffsetConfig.DefaultLoadBufferSize,
                        Long offsetsRetentionMs = OffsetConfig.DefaultOffsetRetentionMs,
                        Long offsetsRetentionCheckIntervalMs = OffsetConfig.DefaultOffsetsRetentionCheckIntervalMs,
                        Integer offsetsTopicNumPartitions = OffsetConfig.DefaultOffsetsTopicNumPartitions,
                        Integer offsetsTopicSegmentBytes = OffsetConfig.DefaultOffsetsTopicSegmentBytes,
                        Short offsetsTopicReplicationFactor = OffsetConfig.DefaultOffsetsTopicReplicationFactor,
                        CompressionCodec offsetsTopicCompressionCodec = OffsetConfig.DefaultOffsetsTopicCompressionCodec,
                        Integer offsetCommitTimeoutMs = OffsetConfig.DefaultOffsetCommitTimeoutMs,
                        Short offsetCommitRequiredAcks = OffsetConfig.DefaultOffsetCommitRequiredAcks);
