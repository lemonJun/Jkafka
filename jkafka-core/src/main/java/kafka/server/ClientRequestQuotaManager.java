...
class ClientRequestQuotaManager(private val ClientQuotaManagerConfig config,
  ...
  override protected public void  throttleTime(KafkaMetric clientMetric, MetricConfig config): Long = {
    math.min(super.throttleTime(clientMetric, config), maxThrottleTimeMs);
  }

  override protected public void  clientRateMetricName(String sanitizedUser, String clientId): MetricName = {
