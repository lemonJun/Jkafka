...
object SecurityUtils {
  ...
  public void  convertToResourceAndAcl(AclBindingFilter filter): Either[ApiError, (Resource, Acl)] = {
    (for {
  ...
  public void  convertToAclBinding(Resource resource, Acl acl): AclBinding = {
