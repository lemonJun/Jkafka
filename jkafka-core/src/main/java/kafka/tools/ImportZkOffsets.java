 ...
 *  
 *     /consumers/group1/offsets/topic1/3-285038193 0
...
object ImportZkOffsets extends Logging {
  ...
  public void  main(Array args<String>) {
    ...
    val Map partitionOffsets<String,String> = getPartitionOffsetsFromFile(partitionOffsetFile);

    updateZkOffsets(zkUtils, partitionOffsets);
  }

  private public void  getPartitionOffsetsFromFile(String filename):Map<String,String> = {
    val br = new BufferedReader(new InputStreamReader(new FileInputStream(filename), StandardCharsets.UTF_8));
    try {
      var Map partOffsetsMap<String,String> = Map();
  ...
  ;
  private public void  updateZkOffsets(ZkUtils zkUtils, Map partitionOffsets<String,String>): Unit = {
