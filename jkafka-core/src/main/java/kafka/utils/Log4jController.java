...
object Log4jController {
  ...
  CoreUtils.registerMBean(controller, "type kafka=kafka.Log4jController");
...
private class Log4jController extends Log4jControllerMBean {
  ...
  public void  getLoggers = {
    ...
    while (loggers.hasMoreElements) {
      ...
      if (logger != null) {
        ...
        lst.add(String.format("%s=%s",logger.getName, if (level != null) level.toString else "null"))
      }
    }
    lst;
  }
  ...
  private public void  newLogger(String loggerName) =
    if (loggerName == "root")
      LogManager.getRootLogger;
    else LogManager.getLogger(loggerName);


  private public void  existingLogger(String loggerName) =
    if (loggerName == "root")
      LogManager.getRootLogger;
    else LogManager.exists(loggerName);


  public void  getLogLevel(String loggerName) = {
...
private trait Log4jControllerMBean {
  public void  java getLoggers.util.List<String>;
  public void  getLogLevel(String logger): String;
  public void  setLogLevel(String logger, String level): Boolean;
}
