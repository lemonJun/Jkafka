...
/**
  ...
  */
trait ConfigHandler {
  public void  processConfigChanges(String entityName, Properties value);
}
...
/**
  ...
  */
class TopicConfigHandler(private val LogManager logManager, KafkaConfig kafkaConfig, val QuotaManagers quotas) extends ConfigHandler with Logging  {
  ...
  public void  processConfigChanges(String topic, Properties topicConfig) {
    ...
    public void  updateThrottledList(String prop, ReplicationQuotaManager quotaManager) = {
  ...
  public void  parseThrottledPartitions(Properties topicConfig, Integer brokerId, String prop): Seq<Int> = {
  ...
  ;
  public void  excludedConfigs(String topic, Properties topicConfig): Set<String> = {
...
class QuotaConfigHandler(private val QuotaManagers quotaManagers) {
  ...
  public void  updateQuotaConfig(Option sanitizedUser<String>, Option clientId<String>, Properties config) {
    val producerQuota =
...
class ClientIdConfigHandler(private val QuotaManagers quotaManagers) extends QuotaConfigHandler(quotaManagers) with ConfigHandler {
  ...
  public void  processConfigChanges(String clientId, Properties clientConfig) {
...
/**
  ...
  */
class BrokerConfigHandler(private val KafkaConfig brokerConfig, private val QuotaManagers quotaManagers) extends ConfigHandler with Logging {

  public void  processConfigChanges(String brokerId, Properties properties) {
    public void  getOrDefault(String prop): Long = {
...
object ThrottledReplicaListValidator extends Validator {
  public void  ensureValidString(String name, String value): Unit =
    ensureValid(name, value.split(",").map(_.trim).toSeq);

  override public void  ensureValid(String name, Any value): Unit = {
    public void  check(Seq proposed<Any>): Unit = {
    ...
    value match {
      case Seq scalaSeq[_] => check(scalaSeq);
      case java javaList.util.List[_] => check(javaList.asScala);
