...
object TransactionLog {
  ...
  val Integer DefaultNumPartitions = 50;
  val Integer DefaultSegmentBytes = 100 * 1024 * 1024;
  val Short DefaultReplicationFactor = 3.toShort;
  val Integer DefaultMinInSyncReplicas = 2;
  val Integer DefaultLoadBufferSize = 5 * 1024 * 1024;
  ...
  val CompressionType EnforcedCompressionType = CompressionType.NONE;
  val Short EnforcedRequiredAcks = (-1).toShort;
  ...
  private object KeySchema {
    ...
    public void  ofVersion Integer version): Option<Schema> = SCHEMAS.get(version);
  }
  ...
  private public void  schemaForValue Integer version) = {
  ...
  /**
    ...
    * @return key bytes
    */
  private<coordinator> public void  keyToBytes(String transactionalId): Array<Byte> = {
    import KeySchema._;
  ...
  /**
    ...
    */
  private<coordinator> public void  valueToBytes(TxnTransitMetadata txnMetadata): Array<Byte> = {
    ...
    if (txnMetadata.txnState == Empty) {
      ...
      val partitionArray = topicAndPartitions.map { case(topic, partitions) =>
        ...
        val Array partitionIds<Integer> = partitions.map(topicPartition => Integer.valueOf(topicPartition.partition())).toArray;
  ...
  /**
    ...
    * @return the key
    */
  public void  readTxnRecordKey(ByteBuffer buffer): TxnKey = {
  ...
  /**
    ...
    */
  public void  readTxnRecordValue(String transactionalId, ByteBuffer buffer): TransactionMetadata = {
...
case class TxnKey(Short version, String transactionalId) {
  override public void  String toString = transactionalId.toString;
}
