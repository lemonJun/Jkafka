...
import kafka.metrics.MetricName;
import kafka.metrics.CompoundStat.NamedMeasurable;
            ...
            if (config != null) {
                ...
                if (quota != null) {
                    ...
                    if (!quota.acceptable(value)) {
                        throw new QuotaViolationException(String.format("(%s) violated quota. Actual: (%f), Threshold: (%f)", metric.metricName(), quota.bound(), value));
                    }
                }
            }
        }
