...
sealed trait IndexEntry {
  ...
  public void  Long indexKey;
  public void  Long indexValue;
}
 ...
 * given offset.
 */
case class OffsetPosition(Long offset, Integer position) extends IndexEntry {
  override public void  indexKey = offset;
  override public void  indexValue = position.toLong;
}
 ...
 */
case class TimestampOffset(Long timestamp, Long offset) extends IndexEntry {
  override public void  indexKey = timestamp;
  override public void  indexValue = offset;
}
