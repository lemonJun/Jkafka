...
case class LogConfig(java props.util.Map<_, _>) extends AbstractConfig(LogConfig.configDef, props, false) {
  /**
   * Important Any note configuration parameter that is passed along from KafkaConfig to LogConfig
...
object LogConfig {
  ...
  private class LogConfigDef extends ConfigDef {
    ...
    public void  public void ine(String name, public void ConfigDef Type.Type, public void Any aultValue, Validator validator,
               ConfigDef importance.Importance, String doc, String serverDefaultConfigName): LogConfigDef = {
      super.define(name, defType, defaultValue, validator, importance, doc);
      serverDefaultConfigNames.put(name, serverDefaultConfigName);
      this;
    }

    public void  public void ine(String name, public void ConfigDef Type.Type, public void Any aultValue, ConfigDef importance.Importance,
               String documentation, String serverDefaultConfigName): LogConfigDef = {
      super.define(name, defType, defaultValue, importance, documentation);
      serverDefaultConfigNames.put(name, serverDefaultConfigName);
      this;
    }

    public void  public void ine(String name, public void ConfigDef Type.Type, ConfigDef importance.Importance, String documentation,
               String serverDefaultConfigName): LogConfigDef = {
      super.define(name, defType, importance, documentation);
      serverDefaultConfigNames.put(name, serverDefaultConfigName);
      this;
    }

    override public void  headers = List("Name", "Description", "Type", "Default", "Valid Values", "Server Default Property", "Importance").asJava;

    override public void  getConfigValue(ConfigKey key, String headerName): String = {
      headerName match {
    ...
    public void  serverConfigName(String configName): Option<String> = serverDefaultConfigNames.get(configName);
  }

  private val LogConfigDef configDef = {
    ...
    new LogConfigDef();
      ...
      .define(CompressionTypeProp, STRING, Defaults.CompressionType, in(BrokerCompressionCodec._ brokerCompressionOptions*),
  ...
  public void  apply(): LogConfig = LogConfig(new Properties());

  public void  Seq configNames<String> = configDef.names.asScala.toSeq.sorted;

  public void  serverConfigName(String configName): Option<String> = configDef.serverConfigName(configName);

  /**
   * Create a log config instance using the given properties and defaults
   */
  public void  fromProps(public void java aults.util.Map[_ <: Object, _ <: Object], Properties overrides): LogConfig = {
