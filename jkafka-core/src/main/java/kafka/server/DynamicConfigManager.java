...
class DynamicConfigManager(private val ZkUtils zkUtils,
                           private val Map configHandlers<String, ConfigHandler>,
  ...
  object ConfigChangedNotificationHandler extends NotificationHandler {
    override public void  processNotification(String json) = {
    ...
    private public void  processEntityConfigChangeVersion1(String json, Map map<String, Any>) {
    ...
    private public void  processEntityConfigChangeVersion2(String json, Map map<String, Any>) {
