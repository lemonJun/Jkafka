...
class OffsetResponse(private val kafka underlying.api.OffsetResponse) {
  ...
  public void  error(String topic, Integer partition) =
  ...
  public void  offsets(String topic, Integer partition) =
  ...
  override public void  equals(Any obj): Boolean = {
    obj match {
      case null => false;
      case OffsetResponse other => this.underlying.equals(other.underlying);
      case _ => false;
    }
  }
