...
trait BaseProducer {
  public void  send(String topic, Array key<Byte>, Array value<Byte>);
  public void  close();
}

@deprecated("This class has been deprecated and will be removed in a future release. " +
            "Please use org.apache.kafka.clients.producer.KafkaProducer instead.", "0.10.0.0");
class NewShinyProducer(Properties producerProps) extends BaseProducer {
  ...
  override public void  send(String topic, Array key<Byte>, Array value<Byte>) {
...
@deprecated("This class has been deprecated and will be removed in a future release. " +
            "Please use org.apache.kafka.clients.producer.KafkaProducer instead.", "0.10.0.0");
class OldProducer(Properties producerProps) extends BaseProducer {
